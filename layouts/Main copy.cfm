<cfoutput>
	...
	<head>
		...
		-->
		<link href="https://cdn.jsdelivr.net/npm/quasar@^1.3.0/dist/quasar.min.css" rel="stylesheet" type="text/css">
		<style>
			.q-tab{
				min-height: 50px;
			}
	...
	<body>
		...
		<script src="https://cdn.jsdelivr.net/npm/quasar@^1.3.0/dist/quasar.ie.polyfills.umd.min.js"></script>
		...
		Replace version below (1.0.0) with your desired version of Quasar.
		-->
		<script src="https://cdn.jsdelivr.net/npm/quasar@^1.3.0/dist/quasar.umd.min.js"></script>
		<!--
		...
		-->
		<script src="https://cdn.jsdelivr.net/npm/quasar@^1.3.0/dist/icon-set/fontawesome-v5.umd.min.js"></script>
		<script>
